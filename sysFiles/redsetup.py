...
def saveImage(url, save_dir):
    ...
    filename = save_dir + 'img-{}'.format(counter) + url[dot_location: dot_location + 4]
...
def downloadImagesFromReddit(subreddits, postLimit=int(input("Enter Number of images::\t")), scoreLimit=1):
