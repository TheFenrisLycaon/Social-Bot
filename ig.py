...
class InstaBot:
    ...
    def get_posts_tags(self):
        driver = self.driver
        driver.get("https://www.instagram.com/explore/tags/{}/".format(
        ...
        for i in range(n):
            ...
            try:
                driver.find_element_by_css_selector(
                    "#react-root > section > main > div > div.ltEKP > article > div.eo2As > section.ltpMr.Slqrh > span.fr66n > button").click()
                sleep(3)
                self.posts.pop(m)
    ...
    def both(self, n):
        ...
        for i in range(n):
            ...
            try:
                ...
                sleep(5)
                driver.find_element_by_css_selector(
                    "#react-root > section > main > div > div.ltEKP > article > div.eo2As > section.sH9wk._JgwE > div > form > textarea").click()
                driver.find_element_by_css_selector(
                    "#react-root > section > main > div > div.ltEKP > article > div.eo2As > section.sH9wk._JgwE > div > form > textarea").send_keys("{}".format(self.comments[random.randint(0, len(self.comments)-1)]))
                sleep(5)
                driver.find_element_by_css_selector(
                    "#react-root > section > main > div > div.ltEKP > article > div.eo2As > section.sH9wk._JgwE > div > form > button").click()
                self.posts.pop(m)
